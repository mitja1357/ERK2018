...
Because obtained approximation of errors are interdependent, their individual errors can not be summed up. Function that define error for all deformations in (\ref{equ:def_sin}) and (\ref{equ:def_cos}) and impact  of high harmonics distortion is a challenge for further work. 
